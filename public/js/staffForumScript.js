$(document).ready(function () {
    ...
    function createComment(comment,id) {
        ...
        $.post(base_uri+'staff/'+staffId+'/forum/'+id+'/comment', {
            comment: comment,
            postId:id
            }
    ...
    function createPost(){
        ...
        $.post(base_uri+'staff/'+staffId+'/forum/',{
                post:$('#post').val()}
            ,function (data,status){
                loadPost();
    ...
    function loadPost(){
        ...
        $.get(base_uri+'staff/'+staffId+'/forum/all',function (post,status){
            var data=post;
            $("#content").html('');
    ...
    function loadComment(id){
        ...
        $.get(base_uri+'staff/'+staffId+'/forum/'+id+'/comment',{postId:id},function (comments,status){
