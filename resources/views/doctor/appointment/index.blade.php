                    ...
                    <table class="table table-dark table-hover table-striped text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-outline-primary my-2 my-sm-0 chat_session {{$item->start}}" {{$item->start}} href="{{route('docChat.index',[$item->userId,$item->aid])}}"><i class="fa fa-comment fa-lg"></i> Start Chat Session</a>
